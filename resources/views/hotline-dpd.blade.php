    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-center space-x-8 h-14">
                ...
                <a href="{{ route('hotline.dpd') }}" class="inline-flex items-center px-1 pt-1 border-b-2 border-custom text-sm font-medium text-gray-900">Hotline</a>
            </div>
        </div>
    </nav>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">Laporan pengajuan bantuan alat bantu mobilitas</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <form action="{{ route('hotline.terima', 1) }}" method="POST">
    @csrf
